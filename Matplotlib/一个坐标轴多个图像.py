...
# 绘制北京折线图 参数1：x轴数据 2：y轴数据 3：颜色 4：标签 5：线型
plt.plot(x,y_beijing,color = 'blue',label = '北京',linestyle = '--')

# 3.1构造x,y刻度标签 语法：plt.xticks(x刻度值，x刻度标签) plt.yticks(y刻度值，y刻度标签)
